        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{route('admin.riwayat_tagihan.cetak')}}" class="btn btn-info mb-2" style="color: #fff;">Cetak Daftar Tagihan</a>
                        @if(sizeof($dataTagihan) == 0)
                           <h5>Riwayat Tagihan Kosong!</h5>
                        @else
