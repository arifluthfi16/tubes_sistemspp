                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <a href="{{route('admin.pegawai.index')}}" class="btn btn-light" style="text-align: left; color: #333">Daftar Pegawai</a>                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                <div class="card">
                    ...
                    @endif
                        ...
                        @foreach($users_profile as $users_profile)
                            ...
                            <a href="{{Route('admin.siswa.delete', ['id' => $users_profile->user_id])}}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteDataModal">Hapus</a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
